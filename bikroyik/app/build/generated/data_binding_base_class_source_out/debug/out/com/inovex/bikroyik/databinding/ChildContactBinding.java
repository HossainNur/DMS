...
public final class ChildContactBinding implements ViewBinding {
  ...
  private ChildContactBinding(@NonNull ConstraintLayout rootView, @NonNull LinearLayout addClient,
      @NonNull ConstraintLayout btnAddClient, @NonNull ConstraintLayout clientView,
      @NonNull CircleImageView profileImage, @NonNull TextView tvContactName,
  ...
  public static ChildContactBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ChildContactBinding((ConstraintLayout) rootView, addClient, btnAddClient,
          clientView, profileImage, tvContactName, tvPhoneNumber);
    }
