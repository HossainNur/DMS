...
public final class ActivityOrderBinding implements ViewBinding {
  ...
  private ActivityOrderBinding(@NonNull ConstraintLayout rootView, @NonNull View horizontalLine,
      @NonNull ImageView imgListGridSales, @NonNull ImageView imgQuickSales,
      @NonNull LinearLayout linearLayout2, @NonNull LinearLayout llBtnListGridSales,
      @NonNull LinearLayout llBtnSalesCalSales, @NonNull LinearLayout llTotalBill,
      @NonNull SalesToolbarBinding tBarSales, @NonNull TextView tvListGridProductsSales,
      @NonNull TextView tvSalesCalSales, @NonNull TextView tvTotalPriceSales,
      @NonNull ViewPager viewPagerSales) {
  ...
  public static ActivityOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityOrderBinding((ConstraintLayout) rootView, horizontalLine, imgListGridSales,
          imgQuickSales, linearLayout2, llBtnListGridSales, llBtnSalesCalSales, llTotalBill,
          binding_tBarSales, tvListGridProductsSales, tvSalesCalSales, tvTotalPriceSales,
          viewPagerSales);
    }
