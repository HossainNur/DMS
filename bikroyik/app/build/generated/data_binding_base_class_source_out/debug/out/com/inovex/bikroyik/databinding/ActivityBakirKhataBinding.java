...
public final class ActivityBakirKhataBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageView imgListView;
  ...
  @NonNull
  public final TextView tvTotalClient;
  ...
  private ActivityBakirKhataBinding(@NonNull ConstraintLayout rootView,
      @NonNull ConstraintLayout addNewContactLayout, @NonNull LinearLayout btnAddCustomer,
      @NonNull LinearLayout btnSeeReportLl, @NonNull CardView cardView,
      @NonNull ConstraintLayout dueListHeader, @NonNull RecyclerView dueListRecycler,
      @NonNull ImageView imgListView, @NonNull ImageView imgPdf, @NonNull ImageView rightArrow,
      @NonNull TextView text, @NonNull ToolbarBakirKhataBinding toolbar,
      @NonNull CardView totalDueCard, @NonNull TextView tvTotalBaki,
      @NonNull TextView tvTotalClient, @NonNull TextView tvTotalReceive,
      @NonNull TextView tvTotalReceiveAmount) {
    ...
    this.tvTotalClient = tvTotalClient;
  ...
  public static ActivityBakirKhataBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.img_listView;
      ImageView imgListView = rootView.findViewById(id);
      if (imgListView == null) {
        break missingId;
      }

      id = R.id.img_pdf;
      ImageView imgPdf = rootView.findViewById(id);
      if (imgPdf == null) {
        break missingId;
      }
      ...
      id = R.id.tv_totalClient;
      TextView tvTotalClient = rootView.findViewById(id);
      if (tvTotalClient == null) {
        break missingId;
      }
      ...
      return new ActivityBakirKhataBinding((ConstraintLayout) rootView, addNewContactLayout,
          btnAddCustomer, btnSeeReportLl, cardView, dueListHeader, dueListRecycler, imgListView,
          imgPdf, rightArrow, text, binding_toolbar, totalDueCard, tvTotalBaki, tvTotalClient,
