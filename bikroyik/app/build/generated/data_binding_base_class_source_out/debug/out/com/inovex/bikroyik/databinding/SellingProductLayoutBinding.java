...
public final class SellingProductLayoutBinding implements ViewBinding {
  ...
  private SellingProductLayoutBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout bottomLayout, @NonNull RecyclerView itemChargeRecyclerTotalCharge,
      @NonNull LinearLayout llBtnChargeOrder, @NonNull LinearLayout llBtnSaveOrder,
      @NonNull MaterialSpinner spinnerTotalCharge, @NonNull TextView tvCharge,
      @NonNull TextView tvChargeAmount) {
  ...
  public static SellingProductLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new SellingProductLayoutBinding((ConstraintLayout) rootView, bottomLayout,
          itemChargeRecyclerTotalCharge, llBtnChargeOrder, llBtnSaveOrder, spinnerTotalCharge,
          tvCharge, tvChargeAmount);
    }
